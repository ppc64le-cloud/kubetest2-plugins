...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/powervs": &vfsgen۰DirInfo{
			name:    "powervs",
			modTime: time.Date(2020, 8, 31, 8, 29, 41, 204544954, time.UTC),
		},
		...
		"/powervs/main.tf": &vfsgen۰CompressedFileInfo{
			name:             "main.tf",
			modTime:          time.Date(2020, 8, 31, 6, 51, 45, 925438601, time.UTC),
		...
		"/powervs/provider.tf": &vfsgen۰CompressedFileInfo{
			name:             "provider.tf",
			modTime:          time.Date(2020, 8, 31, 8, 29, 41, 204449956, time.UTC),
